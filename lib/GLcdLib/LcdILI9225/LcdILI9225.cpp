...
{
	this->Initialize(ILI9225Config(pinSS, pinDC, width, height, panelSS, panelBGR, panelRev));
}
*/
//初期化
//void	LcdILI9225::Initialize(const ILI9225Config& config)
void	LcdILI9225::Initialize(gpio_num_t pinSS, gpio_num_t pinDC, uint8_t panelSS, uint8_t panelBGR, uint8_t panelRev, int16_t width, int16_t height)
{
...
void	LcdILI9225::SetGRamArea(int16_t x, int16_t y, int16_t w, int16_t h)
{
